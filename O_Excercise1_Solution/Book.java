...
//Abstract để tránh đối tượng ảo vì trong thực tế sách phải là loại củ thể
    private String bookId; //Mã sách
    private String publisher;//Nhà xuất bản
    private Date entryDate;//Nhập ngày
    ...
    public void updateBook(String id) {
        if (this.bookId.equals(id)) {
            try {
                ...
                setQuantity(scanner.nextDouble());
                scanner.nextLine();
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");//Thiết lập ngày tháng
                System.out.println("Enter Entry Date");
                String entryDateString = scanner.nextLine();
                setEntryDate(sdf.parse(entryDateString));
            } catch (ParseException e) {
